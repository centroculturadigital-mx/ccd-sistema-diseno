...
export const tarjetaAparienciaImagen = () => ({
    Component: ThemeTester,
    props: {
        componente: Tarjeta,
        datos: {
...
export const tarjetaAccionEnlacePestannaNueva = () => ({
    Component: ThemeTester,
    props: {
        componente: Tarjeta,
        datos: {
...
export const tarjetaEnlacesSinEnlace = () => ({
    Component: ThemeTester,
    props: {
        componente: Tarjeta,
        datos: {
            ...
            acciones: [accionesFunciones[0], accionesEnlaces[0]],
            pleca,
            enlaces: enlaces.map(e=>({ texto: e.texto }))
        }
    }
});