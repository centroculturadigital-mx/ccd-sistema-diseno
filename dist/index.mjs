(function (exports) {
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	const generarTitulo = (nivel, texto, color) => {
    		...
    		html += generarEtiqueta.abrir("h" + nivel, color ? { style: `color: ${color};` } : null);
    		html += texto;
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*nivel, texto, titulo, color*/ 30) {
    			 $$invalidate(0, tituloRenderear = generarTitulo(nivel, !!texto ? texto : titulo, color));
    		}
    	};

    	return [tituloRenderear, nivel, titulo, color, texto];
    }

    class Titulo extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$6, create_fragment$6, safe_not_equal, { nivel: 1, titulo: 2, color: 3, texto: 4 });
    	}
    }
    ...
    function add_css$6() {
    	var style = element("style");
    	style.id = "svelte-f9w96x-style";
    	style.textContent = "p.svelte-f9w96x{line-height:1.5;padding-bottom:1rem}";
    	append(document.head, style);
    }
    ...
    function create_fragment$7(ctx) {
    	...
    	return {
    		...
    		p(ctx, [dirty]) {
    			if (dirty & /*texto*/ 1) set_data(t, /*texto*/ ctx[0]);
    ...
    class Parrafo extends SvelteComponent {
    	constructor(options) {
    		super();
    		if (!document.getElementById("svelte-f9w96x-style")) add_css$6();
    		init(this, options, instance$7, create_fragment$7, safe_not_equal, { texto: 0, color: 1 });
    	}
    }
    ...
    class Logo extends SvelteComponent {
    	constructor(options) {
    		super();
    		if (!document.getElementById("svelte-1ig8hww-style")) add_css$b();
