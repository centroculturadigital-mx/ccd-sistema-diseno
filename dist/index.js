(function (global, factory) {
    ...
    /* src/elementos/botones/Boton/Boton.svelte generated by Svelte v3.16.0 */

    function add_css$6() {
    	var style = element("style");
    	style.id = "svelte-1gjmup8-style";
    	style.textContent = "button.svelte-1gjmup8{transition:0.5s;background-color:black;color:#FFF;border:none;cursor:pointer;padding:0.5rem 1rem}button.svelte-1gjmup8:hover{box-shadow:1px 1px 2px #477751}";
    	append(document.head, style);
    }
    ...
    function create_fragment$9(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(button, "class", "svelte-1gjmup8");
    ...
    class Boton extends SvelteComponent {
    	constructor(options) {
    		super();
    		if (!document.getElementById("svelte-1gjmup8-style")) add_css$6();
